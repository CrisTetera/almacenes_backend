...
class PchPurchaseDebitNoteTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('pch_purchase_debit_note')->delete();
        
        \DB::table('pch_purchase_debit_note')->insert(array (
            0 => 
            array (
                'id' => 1,
        ...
        \DB::table('pch_purchase_debit_note')->update([
            'created_at' => $now,
            'updated_at' => $now
        ]);
