...
use Modules\Pos\Services\DTEPos\Json\Factura\DteToJson; 
...
use Modules\Pos\Services\DTEPos\Entities\SubsectionDTE\Factura\Encabezado;
use Modules\Pos\Services\DTEPos\Entities\SubsectionDTE\Factura\Emisor;
use Modules\Pos\Services\DTEPos\Entities\SubsectionDTE\Factura\Receptor;
use Modules\Pos\Services\DTEPos\Entities\SubsectionDTE\Factura\Total;
use Modules\Pos\Services\DTEPos\Entities\SubsectionDTE\Factura\Detalle;
use Modules\Pos\Services\DTEPos\Entities\SubsectionDTE\Factura\DescuentoRecargoGlobal;
use Modules\Pos\Services\DTEPos\Entities\SubsectionDTE\Factura\ReferenciaOC;
...
class Factura extends DTE
{
     ...
     * FIXME: Add comments
     */
    public function setTotales($montoExe,$montoNeto, $tasaIVA, $iva, $montoTotal)
    {
        $this->oTotal = new Total($montoExe,$montoNeto, $tasaIVA, $iva, $montoTotal);
    }
