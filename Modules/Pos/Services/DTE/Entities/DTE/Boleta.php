...
use Modules\Pos\Services\DTE\Json\Boleta\DteToJson; 
...
use Modules\Pos\Services\DTE\Entities\SubsectionDTE\Boleta\Encabezado;
use Modules\Pos\Services\DTE\Entities\SubsectionDTE\Boleta\Emisor;
use Modules\Pos\Services\DTE\Entities\SubsectionDTE\Boleta\Receptor;
use Modules\Pos\Services\DTE\Entities\SubsectionDTE\Boleta\Total;
use Modules\Pos\Services\DTE\Entities\SubsectionDTE\Boleta\Detalle;
use Modules\Pos\Services\DTE\Entities\SubsectionDTE\Boleta\DescuentoRecargoGlobal;
...
class Boleta extends DTE
{
     ...
     * FIXME: Add comments
     */
    public function setTotales($montoTotal)
    {
        $this->oTotal = new Total($montoTotal);
    }
