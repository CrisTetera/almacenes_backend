...
namespace Modules\Pos\Tests\Unit\PosSaleRollback;
 ...
 */
class PosSaleRollbackTest extends TestCase
{
    /**
     ...
     * @return void
     */
    public function test_rollback_pos_sale_success_with_updated_sales() {
     ...
     * @return void
     */
    public function test_rollback_pos_sale_success_without_updated_sales() {
        // Call artisan command
        \Artisan::call("open_sales:rollback");
        $response = getArtisanCommandResponse();
