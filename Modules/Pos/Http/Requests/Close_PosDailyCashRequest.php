...
class Close_PosDailyCashRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'g_cashier_closure_user_id' => 'required|integer|exists:g_user,id',
            'auth_code_supervisor' => 'required|string|max:12|exists:g_user,bar_auth_code',
