...
class PayTrustedSaleRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'pos_trusted_sale_id' => 'required|integer|exists:pos_trusted_sale_pos,id',
            ...
            'pos_movement_ingress_type_id'  => 'required|integer|min:1|exists:pos_movement_ingress_type_pos,id',
            ...
            'pos_payment_sale.*.sl_customer_id' => 'required|integer|min:1|exists:sl_customer_pos,id',
