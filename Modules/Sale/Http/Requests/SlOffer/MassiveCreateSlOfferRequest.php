...
class MassiveCreateSlOfferRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'wh_products' => 'bail|required|array_structure_create_massive|exists_from_array_create_massive:wh_product,id',
            'g_branch_office_id' => 'required|integer|exists:g_branch_office,id',
