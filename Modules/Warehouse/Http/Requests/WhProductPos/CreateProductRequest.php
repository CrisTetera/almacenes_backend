...
class CreateProductRequest extends FormRequest
{
    ...
    {
        return [
            // 'wh_item_id' => 'nullable|integer|min:1|exists:wh_item_pos,id',
            // 'wh_pack_id' => 'nullable|integer|min:1|exists:wh_pack,id',
            // 'wh_promo_id' => 'nullable|integer|min:1|exists:wh_promo_pos,id',
            'name' => 'required|string|max:255',
            'description'=> 'required|string|max:255',
            'wh_subfamily_id' => 'nullable|integer|min:1|exists:wh_subfamily_pos,id',
