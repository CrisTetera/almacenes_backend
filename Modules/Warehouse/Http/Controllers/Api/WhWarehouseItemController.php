...
class WhWarehouseItemController extends Controller
{
    /**
    ...
    {
        $query =  QueryBuilder::for(WhWarehouseItem::orderBy('id'))
                            ->allowedIncludes(
                                'wh_warehouse',
                                'wh_item.wh_product_pos'
                            )
                            ->allowedFilters(
    ...
    {
        return QueryBuilder::for(WhWarehouseItem::where('id', $idWhWarehouseItem))
                            ->allowedIncludes(
                                'wh_warehouse',
                                'wh_item.wh_product'
                            )
     ...
     *
     * @param  \Modules\Warehouse\Entities\WhWarehouseItem  $whWarehouseItem
     * @return \Illuminate\Http\Response
     */
