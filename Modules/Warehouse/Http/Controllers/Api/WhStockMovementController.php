...
class WhStockMovementController extends Controller
{
    /**
    ...
    {
        $query =  QueryBuilder::for(WhStockMovement::orderBy('id'))
                            ->allowedIncludes(
                                'wh_item',
                                'wh_warehouse',
    ...
    {
        return QueryBuilder::for(WhStockMovement::where('id', $idWhStockMovement))
                            ->allowedIncludes(
                                'wh_item',
                                'wh_warehouse',
                                'wh_warehouse_movement',
     ...
     *
     * @param  \Modules\Warehouse\Entities\WhStockMovement  $whStockMovement
     * @return \Illuminate\Http\Response
     */
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, WhStockMovement $whStockMovement)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(WhStockMovement $whStockMovement)
    {
        //
    }
}
